export function greedySampling(x, tokenHistory = undefined, repetition_penalty = 0) {
...
export function npsample(ozut, temp = 1.0, top_p_usual = 0.8, tokenHistory = undefined, repetition_penalty = 0) {  
