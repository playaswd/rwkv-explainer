...
<div class="top-bar flex w-full items-center gap-4 px-10 py-2 pb-3" class:active={isActive}>
	<div class="logo text-bold text-gray-700" data-click="logo">
		R<span class="small">WKV</span> E<span class="small">XPLAINER</span>
	</div>
	...
	<div class="icons flex items-center gap-3">
		<!-- arxiv -->
		<a href="https://arxiv.org/abs/2305.13048" target="_blank" data-click="pdf-btn">
			<svg
		...
		<!-- video -->
		<!-- <a href="https://www.youtube.com/watch?v=xxxxxx" target="_blank" data-click="ytb-btn">
			<svg
				class="h-6 w-6 text-gray-800 dark:text-white"
				aria-hidden="true"
				xmlns="http://www.w3.org/2000/svg"
		...
		<!-- repo -->
		<a
			href="https://github.com/playaswd/rwkv-explainer"
			target="_blank"
